...
<nav class="main-nav--bg" style="background-color: black">
    ...
    <div style="display:flex;flex-direction:row;justify-content:space-between;margin:5px;text-align:center;color:white">
        ...
        <div>
            <p style="font-size:15px;float:right">${countArriveredOrderAdmin}</p></br> <a style="color:yellow;font-size:25px;font-weight:bold"  href="/backend/order/arrivered">已到 </a>
        </div>
        <div>
            </br>|
        </div>
