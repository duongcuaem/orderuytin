...
<nav class="main-nav--bg">
    <div class="container main-nav">
        <div class="main-nav-end">
            ...
            <div style="font-size:35px" class="mainnavIcon">
            ...
            <div style="font-size:35px" class="mainnavIcon">
                <a href="/backend/home"><i class="fa-solid fa-house-user"></i> </a>
            </div>
            <div style="font-size:35px" class="mainnavIcon">
                <a href="/backend/item/cart">
                    <p style="color:red;font-size:15px;float:right">${countCartItemAdmin}</p>
            ...
            <p>
                <form:form action="/logout"   method="POST">
                    <button type="submit"  style="font-size:35px"><i class="fa-solid fa-right-from-bracket"></i></button>
                </form:form>
            </p>
        </div>
    </div>
    <div style="display:flex;flex-direction:row;justify-content:space-between;margin:5px;text-align:center">
        <div>
            <p style="color:red;font-size:15px;float:right">${countFixOrderAdmin}</p></br>
            <a style="font-size:20px" href="/backend/order/fix">改单</a>
        </div>
        <div>
            </br> |
        </div>
        <div>
            <p style="color:red;font-size:15px;float:right">${countPendingOrderAdmin}</p></br>
            <a style="font-size:20px" href="/backend/order/pending"> 等买 </a>
        </div>
        <div>
            </br>|
        </div>
        <div>
            <p style="color:red;font-size:15px;float:right">${countBoughtOrderAdmin}</p></br>
            <a style="font-size:20px"  href="/backend/order/bought"> 已买</a>
        </div>
        <div>
            </br> |
        </div>
        <div>
            <p style="color:red;font-size:15px;float:right">${countDeliveredOrderAdmin}</p></br>
            <a style="font-size:20px"  href="/backend/order/deliveried"> 已发</a>
        </div>
        <div>
            </br> |
        </div>
        <div>
            <p style="color:red;font-size:15px;float:right">${countArriveredOrderAdmin}</p></br>
            <a style="font-size:20px"  href="/backend/order/arrivered">已到 </a>
        </div>
        <div>
            </br>|
        </div>
        <div>
            <p style="color:red;font-size:15px;float:right">${countComplainOrderAdmin}</p> </br>
            <a style="font-size:20px"  href="/backend/order/complain"> 投诉 </a>
        </div>
        <div>
            </br>|
        </div>
        <div>
            <p style="color:red;font-size:15px;float:right">${countFinishedOrderAdmin}</p></br>
            <a style="font-size:20px" href="/backend/order/finished"> 成功 </a>
        </div>
        <div>
            </br>|
        </div>
        <div>
            <p style="color:red;font-size:15px;float:right">${countCancelOrderAdmin+countCancelItemAdmin}</p></br>
            <a style="font-size:20px"  href="/backend/order/cancel"> 取消  </a>
        </div>
    </div>
