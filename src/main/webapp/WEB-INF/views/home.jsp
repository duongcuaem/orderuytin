...
<html>
<head>
    <title>T&igrave;m h&agrave;ng trung quốc gi&aacute; rẻ</title>
...
<div style="background-image: url('/orderuytin/banner.jpg');min-height: 100px;
background-attachment: fixed;
background-position: center;
background-repeat: no-repeat;
background-size: cover;">
    <div style="padding:10%;text-align:center;font-size:30px;font-weight:bold;background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.5);color: #f1f1f1;">
...
<div style="background-image: url('/orderuytin/banner1.jpg');min-height: 500px;
background-attachment: fixed;
background-position: center;
background-repeat: no-repeat;
background-size: cover;">
    <div style="padding:10%;text-align:center;font-size:50px;font-weight:bold;background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.5);color: #f1f1f1;">
...
<div class="content">
    <div class="container">
        <div class="head-text">
            Dịch vụ Orderuytin.com cung cấp
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
...
<div style="background-image: url('/orderuytin/banner2.jpg');min-height: 500px;
background-attachment: fixed;
background-position: center;
background-repeat: no-repeat;
background-size: cover;">
    <div style="padding:10%;background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.5);color: #f1f1f1;">
    <div class="rate-img">
        <div class="container">
...
<%--                </li>--%>
<%--                <li class="item-list">--%>
<%--                    <a href="${pageContext.request.contextPath}/blogs/2">Hướng dẫn</a>--%>
<%--                </li>--%>
            </ul>
        </div>
